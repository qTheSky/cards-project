...
export const PackOwnerMenu = () => {
		...
		const isPrivatePack = useAppSelector(state => state.cards.cardsState.packPrivate)
				...
				<div style={{position: 'relative'}}>
						...
						{isMenuOpen &&
								<Paper style={{
										...
										<EditPackModal view="packOwnerMenu" id={packId} packName={packName} isPrivatePack={isPrivatePack}/>
